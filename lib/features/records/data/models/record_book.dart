...
class RecordBook {
  ...
  Color get statusColor {
    ...
    if (statusLabel != null && (statusLabel!.contains('نشط') || statusLabel!.contains('Active'))) return Colors.green;
    if (statusLabel != null && (statusLabel!.contains('مكتمل') || statusLabel!.contains('Full'))) return Colors.blue;
    if (statusLabel != null && (statusLabel!.contains('ملغى') || statusLabel!.contains('Cancelled'))) return Colors.red;
    return Colors.grey;
  }
}
